...
class PI_SimpleTwitterTweets extends WP_Widget{
	...
	function widget($args, $instance){
		...
		if (!empty($PI_title))
			...
			if($twitterFollow){ ?>
				<div class="twitter-follow-container"><a href="https://twitter.com/<?php echo $PI_name; ?>" class="twitter-follow-button" data-show-count="<?php echo $dataShowCount; ?>" data-show-screen-name="<?php echo $dataShowScreenName; ?>" data-lang="<?php echo $dataLang; ?>"><?php _e('Follow Us','simple-twitter-tweets'); ?> @<?php echo $PI_name; ?></a></div>
